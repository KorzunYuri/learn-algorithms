...
import com.yurykorzun.learn.algorithms.java.strings.charsetwindow.Solver2_1;
import com.yurykorzun.learn.algorithms.java.strings.charsetwindow.Solver2_2;
...
public class FindShortestSubstringContainingSetOfLetters {
    ...
    public static void main(String[] args) {
        ...
        checker.checkAll(new Solver2_1());
        checker.checkAll(new Solver2_2());
    }
